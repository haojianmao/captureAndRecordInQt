...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScreenShotDialog_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 17, 15), // "beginSelectArea"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 15) // "storeScreenShot"

    },
    "ScreenShotDialog\0beginSelectArea\0\0"
    "storeScreenShot"
};
...
void ScreenShotDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->beginSelectArea(); break;
        case 1: _t->storeScreenShot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject ScreenShotDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ScreenShotDialog.data,
    qt_meta_data_ScreenShotDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ScreenShotDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScreenShotDialog.stringdata0))
